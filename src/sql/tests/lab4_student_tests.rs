    ...
    SqlStudentRunner::new(&engine)
        ...
        .select_expect(
            ...
            "data_officerallegation.id, data_officerallegation.crid, \
                ...
                8, 104, 2, Failure to de-escalate a potentially dangerous situation., 2, Jane, Smith, 1985, 2010, F, Black ; \
                9, 105, 4, Misuse of police authority to access personal records., 4, Emily, Brown, 1990, 2012, F, Asian",
